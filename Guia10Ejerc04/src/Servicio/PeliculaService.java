...
/**
 * En el servicio deberemos tener un bucle que crea un objeto Entidad.Pelicula pidiéndole al usuario
 * todos sus datos y guardándolos en el objeto Entidad.Pelicula.
 * Después, esa Entidad.Pelicula se guarda una lista de Peliculas y se le pregunta al usuario si quiere
 * crear otra Entidad.Pelicula o no.
 */
